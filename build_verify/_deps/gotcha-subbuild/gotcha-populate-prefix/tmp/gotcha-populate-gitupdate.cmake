...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "/usr/tce/bin/git" rev-parse "${ref}^0"
...
execute_process(
  COMMAND "/usr/tce/bin/git" show-ref "v1.0.10"
  WORKING_DIRECTORY "/usr/workspace/haridev/dftracer-project/brahma/build_verify/_deps/gotcha-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v1.0.10" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/v1.0.10")
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "/usr/tce/bin/git" fetch --tags --force "origin"
    WORKING_DIRECTORY "/usr/workspace/haridev/dftracer-project/brahma/build_verify/_deps/gotcha-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "/usr/tce/bin/git" symbolic-ref -q HEAD
    WORKING_DIRECTORY "/usr/workspace/haridev/dftracer-project/brahma/build_verify/_deps/gotcha-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "/usr/tce/bin/git" for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "/usr/workspace/haridev/dftracer-project/brahma/build_verify/_deps/gotcha-src"
...
execute_process(
  COMMAND "/usr/tce/bin/git" status --porcelain
  WORKING_DIRECTORY "/usr/workspace/haridev/dftracer-project/brahma/build_verify/_deps/gotcha-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "/usr/tce/bin/git" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "/usr/workspace/haridev/dftracer-project/brahma/build_verify/_deps/gotcha-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "/usr/tce/bin/git" checkout "${checkout_name}"
    WORKING_DIRECTORY "/usr/workspace/haridev/dftracer-project/brahma/build_verify/_deps/gotcha-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "/usr/tce/bin/git" rebase "${checkout_name}"
    WORKING_DIRECTORY "/usr/workspace/haridev/dftracer-project/brahma/build_verify/_deps/gotcha-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/usr/tce/bin/git" rebase --abort
      WORKING_DIRECTORY "/usr/workspace/haridev/dftracer-project/brahma/build_verify/_deps/gotcha-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "/usr/tce/bin/git" stash pop --index --quiet
          WORKING_DIRECTORY "/usr/workspace/haridev/dftracer-project/brahma/build_verify/_deps/gotcha-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: '/usr/workspace/haridev/dftracer-project/brahma/build_verify/_deps/gotcha-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/usr/tce/bin/git" reset --hard --quiet
      WORKING_DIRECTORY "/usr/workspace/haridev/dftracer-project/brahma/build_verify/_deps/gotcha-src"
    )
    execute_process(
      COMMAND "/usr/tce/bin/git" stash pop --quiet
      WORKING_DIRECTORY "/usr/workspace/haridev/dftracer-project/brahma/build_verify/_deps/gotcha-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "/usr/tce/bin/git" reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "/usr/workspace/haridev/dftracer-project/brahma/build_verify/_deps/gotcha-src"
      )
      execute_process(
        COMMAND "/usr/tce/bin/git" stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/usr/workspace/haridev/dftracer-project/brahma/build_verify/_deps/gotcha-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "/usr/tce/bin/git" submodule update  --init 
    WORKING_DIRECTORY "/usr/workspace/haridev/dftracer-project/brahma/build_verify/_deps/gotcha-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
