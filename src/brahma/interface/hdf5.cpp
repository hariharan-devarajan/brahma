...
size_t HDF5::unbind() {
  ...
  if (num_bindings > 0) {
    ...
    sprintf(unbind_name, "%s_hdf5_unbind", tool_name);
...
hid_t HDF5::H5Iget_file_id(hid_t id) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
ssize_t HDF5::H5Iget_name(hid_t id, char *name, int size) {
...
int HDF5::H5Iget_ref(hid_t id) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
H5I_type_t HDF5::H5Iregister_type(int hash_size, unsigned int reserved,
...
htri_t HDF5::H5Iis_valid(hid_t id) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
hid_t HDF5::H5Tcreate(H5T_class_t type, int size) {
...
htri_t HDF5::H5Tcommitted(hid_t type_id) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Tencode(hid_t obj_id, void *buf, int *nalloc) {
...
hid_t HDF5::H5Tdecode(const void *buf) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Tinsert(hid_t parent_id, const char *name, int offset,
                       hid_t member_id) {
...
H5T_sign_t HDF5::H5Tget_sign(hid_t type_id) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Tget_fields(hid_t type_id, int *spos, int *epos, int *esize,
                           int *mpos, int *msize) {
...
hid_t HDF5::H5Tget_native_type(hid_t type_id, H5T_direction_t direction) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Tset_size(hid_t type_id, int size) {
...
herr_t HDF5::H5Tset_order(hid_t type_id, H5T_order_t order) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Tset_precision(hid_t type_id, int prec) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Tset_offset(hid_t type_id, int offset) {
...
herr_t HDF5::H5Tset_sign(hid_t type_id, H5T_sign_t sign) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Tset_fields(hid_t type_id, int spos, int epos, int esize,
                           int mpos, int msize) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Tset_ebias(hid_t type_id, int ebias) {
...
htri_t HDF5::H5Tcompiler_conv(hid_t src_id, hid_t dst_id) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Tconvert(hid_t src_id, hid_t dst_id, int nelmts, void *buf,
...
herr_t HDF5::H5Ldelete_by_idx(hid_t loc_id, const char *group_name,
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Lget_val(hid_t loc_id, const char *name, void *buf, int size,
                        hid_t lapl_id) {
...
herr_t HDF5::H5Lget_val_by_idx(hid_t loc_id, const char *group_name,
                               H5_index_t idx_type, H5_iter_order_t order,
                               hsize_t n, void *buf, int size, hid_t lapl_id) {
  BRAHMA_UNWRAPPED_FUNC(
...
herr_t HDF5::H5Lcreate_ud(hid_t link_loc_id, const char *link_name,
                          ...
                          int udata_size, hid_t lcpl_id, hid_t lapl_id) {
  BRAHMA_UNWRAPPED_FUNC(
      H5Lcreate_ud, herr_t,
...
htri_t HDF5::H5Lis_registered(H5L_type_t id) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Lunpack_elink_val(const void *ext_linkval, int link_size,
...
herr_t HDF5::H5Oset_comment_by_name(hid_t loc_id, const char *name,
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
ssize_t HDF5::H5Oget_comment(hid_t obj_id, char *comment, int bufsize) {
...
herr_t HDF5::H5Aget_info_by_name(hid_t loc_id, const char *obj_name,
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
ssize_t HDF5::H5Aget_name(hid_t attr_id, int buf_size, char *buf) {
...
herr_t HDF5::H5Eclose_stack(hid_t stack_id) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
ssize_t HDF5::H5Eget_class_name(hid_t class_id, char *name, int size) {
...
herr_t HDF5::H5Eset_current_stack(hid_t err_stack_id) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Epop(hid_t err_stack, int count) {
...
herr_t HDF5::H5Eauto_is_v2(hid_t err_stack, unsigned int *is_stack) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
ssize_t HDF5::H5Eget_msg(hid_t msg_id, H5E_type_t *type, char *msg, int size) {
...
ssize_t HDF5::H5Fget_obj_count(hid_t file_id, unsigned int types) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
ssize_t HDF5::H5Fget_obj_ids(hid_t file_id, unsigned int types, int max_objs,
                             hid_t *obj_id_list) {
...
herr_t HDF5::H5Fget_filesize(hid_t file_id, hsize_t *size) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
ssize_t HDF5::H5Fget_file_image(hid_t file_id, void *buf_ptr, int buf_len) {
...
herr_t HDF5::H5Fget_mdc_hit_rate(hid_t file_id, double *hit_rate_ptr) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Fget_mdc_size(hid_t file_id, int *max_size_ptr,
...
herr_t HDF5::H5Freset_mdc_hit_rate_stats(hid_t file_id) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
ssize_t HDF5::H5Fget_name(hid_t obj_id, char *name, int size) {
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5FDquery(const H5FD_t *f, unsigned long *flags) {
  BRAHMA_UNWRAPPED_FUNC(H5FDquery, herr_t, (f, flags));
  return result;
}
#endif
...
herr_t HDF5::H5FDread(H5FD_t *file, H5FD_mem_t type, hid_t dxpl_id,
                      haddr_t addr, int size, void *buf) {
...
herr_t HDF5::H5Gclose(hid_t group_id) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
hid_t HDF5::H5Gcreate1(hid_t loc_id, const char *name, int size_hint) {
...
herr_t HDF5::H5Gunlink(hid_t loc_id, const char *name) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Gget_linkval(hid_t loc_id, const char *name, int size,
                            char *buf) {
...
herr_t HDF5::H5Gset_comment(hid_t loc_id, const char *name,
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
int HDF5::H5Gget_comment(hid_t loc_id, const char *name, int bufsize,
                         char *buf) {
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pget_nprops(hid_t id, int *nprops) {
  BRAHMA_UNWRAPPED_FUNC(H5Pget_nprops, herr_t, (id, nprops));
  return result;
}
#endif
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pget_size(hid_t id, const char *name, int *size) {
  BRAHMA_UNWRAPPED_FUNC(H5Pget_size, herr_t, (id, name, size));
  return result;
}
#endif
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pinsert2(hid_t plist_id, const char *name, int size, void *value,
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pregister2(hid_t cls_id, const char *name, int size,
                          void *def_value, H5P_prp_create_func_t create,
                          H5P_prp_set_func_t set, H5P_prp_get_func_t get,
                          H5P_prp_delete_func_t prp_del,
                          H5P_prp_copy_func_t copy,
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pget_sizes(hid_t plist_id, int *sizeof_addr, int *sizeof_size) {
  BRAHMA_UNWRAPPED_FUNC(H5Pget_sizes, herr_t,
                        (plist_id, sizeof_addr, sizeof_size));
  return result;
}
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pset_sizes(hid_t plist_id, int sizeof_addr, int sizeof_size) {
  BRAHMA_UNWRAPPED_FUNC(H5Pset_sizes, herr_t,
                        (plist_id, sizeof_addr, sizeof_size));
  return result;
}
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pget_cache(hid_t plist_id, int *mdc_nelmts, int *rdcc_nslots,
                          int *rdcc_nbytes, double *rdcc_w0) {
  BRAHMA_UNWRAPPED_FUNC(
      H5Pget_cache, herr_t,
      (plist_id, mdc_nelmts, rdcc_nslots, rdcc_nbytes, rdcc_w0));
  return result;
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pget_sieve_buf_size(hid_t fapl_id, int *size) {
  BRAHMA_UNWRAPPED_FUNC(H5Pget_sieve_buf_size, herr_t, (fapl_id, size));
  return result;
}
#endif
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pset_cache(hid_t plist_id, int mdc_nelmts, int rdcc_nslots,
                          int rdcc_nbytes, double rdcc_w0) {
  BRAHMA_UNWRAPPED_FUNC(
      H5Pset_cache, herr_t,
      (plist_id, mdc_nelmts, rdcc_nslots, rdcc_nbytes, rdcc_w0));
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pset_file_image(hid_t fapl_id, void *buf_ptr, int buf_len) {
  BRAHMA_UNWRAPPED_FUNC(H5Pset_file_image, herr_t, (fapl_id, buf_ptr, buf_len));
  return result;
}
#endif
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pset_sieve_buf_size(hid_t fapl_id, int size) {
  BRAHMA_UNWRAPPED_FUNC(H5Pset_sieve_buf_size, herr_t, (fapl_id, size));
  return result;
}
#endif
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pget_external(hid_t plist_id, unsigned int idx, int name_size,
                             char *name, off_t *offset, hsize_t *size) {
  BRAHMA_UNWRAPPED_FUNC(H5Pget_external, herr_t,
                        (plist_id, idx, name_size, name, offset, size));
  return result;
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pget_chunk_cache(hid_t dapl_id, int *rdcc_nslots,
                                int *rdcc_nbytes, double *rdcc_w0) {
  BRAHMA_UNWRAPPED_FUNC(H5Pget_chunk_cache, herr_t,
                        (dapl_id, rdcc_nslots, rdcc_nbytes, rdcc_w0));
  return result;
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
ssize_t HDF5::H5Pget_efile_prefix(hid_t dapl_id, char *prefix, int size) {
  BRAHMA_UNWRAPPED_FUNC(H5Pget_efile_prefix, ssize_t, (dapl_id, prefix, size));
  return result;
}
#endif
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pset_chunk_cache(hid_t dapl_id, int rdcc_nslots, int rdcc_nbytes,
                                double rdcc_w0) {
  BRAHMA_UNWRAPPED_FUNC(H5Pset_chunk_cache, herr_t,
                        (dapl_id, rdcc_nslots, rdcc_nbytes, rdcc_w0));
  return result;
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pget_hyper_vector_size(hid_t fapl_id, int *size) {
  BRAHMA_UNWRAPPED_FUNC(H5Pget_hyper_vector_size, herr_t, (fapl_id, size));
  return result;
}
#endif
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pset_buffer(hid_t plist_id, int size, void *tconv, void *bkg) {
  BRAHMA_UNWRAPPED_FUNC(H5Pset_buffer, herr_t, (plist_id, size, tconv, bkg));
  return result;
}
#endif
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pset_hyper_vector_size(hid_t plist_id, int size) {
  BRAHMA_UNWRAPPED_FUNC(H5Pset_hyper_vector_size, herr_t, (plist_id, size));
  return result;
}
#endif
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pget_local_heap_size_hint(hid_t plist_id, int *size_hint) {
  BRAHMA_UNWRAPPED_FUNC(H5Pget_local_heap_size_hint, herr_t,
                        (plist_id, size_hint));
  return result;
}
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pset_local_heap_size_hint(hid_t plist_id, int size_hint) {
  BRAHMA_UNWRAPPED_FUNC(H5Pset_local_heap_size_hint, herr_t,
                        (plist_id, size_hint));
  return result;
}
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
ssize_t HDF5::H5Pget_elink_prefix(hid_t plist_id, char *prefix, int size) {
  BRAHMA_UNWRAPPED_FUNC(H5Pget_elink_prefix, ssize_t, (plist_id, prefix, size));
  return result;
}
#endif
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pget_nlinks(hid_t plist_id, int *nlinks) {
  BRAHMA_UNWRAPPED_FUNC(H5Pget_nlinks, herr_t, (plist_id, nlinks));
  return result;
}
#endif
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pset_nlinks(hid_t plist_id, int nlinks) {
  BRAHMA_UNWRAPPED_FUNC(H5Pset_nlinks, herr_t, (plist_id, nlinks));
  return result;
}
#endif
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pregister1(hid_t cls_id, const char *name, int size,
                          void *def_value, H5P_prp_create_func_t prp_create,
                          H5P_prp_set_func_t prp_set,
                          H5P_prp_get_func_t prp_get,
                          H5P_prp_delete_func_t prp_del,
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pinsert1(hid_t plist_id, const char *name, int size, void *value,
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
ssize_t HDF5::H5PLget(unsigned int index, char *path_buf, int buf_size) {
  BRAHMA_UNWRAPPED_FUNC(H5PLget, ssize_t, (index, path_buf, buf_size));
  return result;
}
#endif
...
herr_t HDF5::H5Sencode(hid_t obj_id, void *buf, int *nalloc) {
  BRAHMA_UNWRAPPED_FUNC(H5Sencode, herr_t, (obj_id, buf, nalloc));
  return result;
}
#endif
...
herr_t HDF5::H5Sselect_elements(hid_t space_id, H5S_seloper_t op,
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Sselect_elements(hid_t space_id, H5S_seloper_t op, int num_elem,
                                const hsize_t *coord) {
  BRAHMA_UNWRAPPED_FUNC(H5Sselect_elements, herr_t,
                        (space_id, op, num_elem, coord));
  return result;
...
void HDF5::H5FD_mpio_term(void) {
  BRAHMA_UNWRAPPED_FUNC_VOID(H5FD_mpio_term, ());
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Pset_fapl_mpio(hid_t fapl_id, MPI_Comm comm, MPI_Info info) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Pget_fapl_mpio(hid_t fapl_id, MPI_Comm *comm, MPI_Info *info) {
...
herr_t HDF5::H5Fstart_swmr_write(hid_t file_id) {
  ...
  return result;
     ...
     (BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
ssize_t HDF5::H5Fget_free_sections(hid_t file_id, H5F_mem_t type, int nsects,
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pget_page_buffer_size(hid_t plist_id, int *buf_size,
                                     unsigned int *min_meta_perc,
                                     unsigned int *min_raw_perc) {
  BRAHMA_UNWRAPPED_FUNC(H5Pget_page_buffer_size, herr_t,
                        (plist_id, buf_size, min_meta_perc, min_raw_perc));
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pset_page_buffer_size(hid_t plist_id, int buf_size,
                                     unsigned int min_meta_per,
                                     unsigned int min_raw_per) {
  BRAHMA_UNWRAPPED_FUNC(H5Pset_page_buffer_size, herr_t,
                        (plist_id, buf_size, min_meta_per, min_raw_per));
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pget_virtual_count(hid_t dcpl_id, int *count) {
  BRAHMA_UNWRAPPED_FUNC(H5Pget_virtual_count, herr_t, (dcpl_id, count));
  return result;
}
#endif
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
ssize_t HDF5::H5Pget_virtual_dsetname(hid_t dcpl_id, int index, char *name,
                                      int size) {
  BRAHMA_UNWRAPPED_FUNC(H5Pget_virtual_dsetname, ssize_t,
                        (dcpl_id, index, name, size));
  return result;
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
ssize_t HDF5::H5Pget_virtual_filename(hid_t dcpl_id, int index, char *name,
                                      int size) {
  BRAHMA_UNWRAPPED_FUNC(H5Pget_virtual_filename, ssize_t,
                        (dcpl_id, index, name, size));
  return result;
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
hid_t HDF5::H5Pget_virtual_srcspace(hid_t dcpl_id, int index) {
  BRAHMA_UNWRAPPED_FUNC(H5Pget_virtual_srcspace, hid_t, (dcpl_id, index));
  return result;
}
#endif
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
hid_t HDF5::H5Pget_virtual_vspace(hid_t dcpl_id, int index) {
  BRAHMA_UNWRAPPED_FUNC(H5Pget_virtual_vspace, hid_t, (dcpl_id, index));
  return result;
}
#endif
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
ssize_t HDF5::H5Pget_virtual_prefix(hid_t dapl_id, char *prefix, int size) {
  BRAHMA_UNWRAPPED_FUNC(H5Pget_virtual_prefix, ssize_t,
                        (dapl_id, prefix, size));
  return result;
}
...
#if ((BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Sencode2(hid_t obj_id, void *buf, int *nalloc, hid_t fapl) {
...
#if ((BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
hid_t HDF5::H5Ssel_iter_create(hid_t spaceid, int elmt_size,
                               unsigned int flags) {
...
#if ((BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Ssel_iter_get_seq_list(hid_t sel_iter_id, int maxseq,
                                      int maxbytes, int *nseq, int *nbytes,
                                      hsize_t *off, int *len) {
  BRAHMA_UNWRAPPED_FUNC(
...
#if ((BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Sencode1(hid_t obj_id, void *buf, int *nalloc) {
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pencode2(hid_t plist_id, void *buf, int *nalloc, hid_t fapl_id) {
  BRAHMA_UNWRAPPED_FUNC(H5Pencode2, herr_t, (plist_id, buf, nalloc, fapl_id));
  return result;
}
#endif
...
#if ((BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Pget_mpi_params(hid_t fapl_id, MPI_Comm *comm, MPI_Info *info) {
...
#if ((BRAHMA_HDF5_VERSION >= 101203 && BRAHMA_HDF5_VERSION < 101300) || \
     (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500))
herr_t HDF5::H5Pset_mpi_params(hid_t fapl_id, MPI_Comm comm, MPI_Info info) {
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pencode1(hid_t plist_id, void *buf, int *nalloc) {
  BRAHMA_UNWRAPPED_FUNC(H5Pencode1, herr_t, (plist_id, buf, nalloc));
  return result;
}
#endif
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
ssize_t HDF5::H5Rget_file_name(const H5R_ref_t *ref_ptr, char *name, int size) {
  BRAHMA_UNWRAPPED_FUNC(H5Rget_file_name, ssize_t, (ref_ptr, name, size));
  return result;
}
#endif
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
ssize_t HDF5::H5Rget_attr_name(const H5R_ref_t *ref_ptr, char *name, int size) {
  BRAHMA_UNWRAPPED_FUNC(H5Rget_attr_name, ssize_t, (ref_ptr, name, size));
  return result;
}
#endif
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Dread_multi(int count, hid_t dset_id[], hid_t mem_type_id[],
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Dread_multi_async(int count, hid_t dset_id[],
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Dwrite_multi(int count, hid_t dset_id[], hid_t mem_type_id[],
                            hid_t mem_space_id[], hid_t file_space_id[],
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Dwrite_multi_async(int count, hid_t dset_id[],
                                  hid_t mem_type_id[], hid_t mem_space_id[],
                                  hid_t file_space_id[], hid_t dxpl_id,
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Eis_paused(hid_t stack_id, hbool_t *is_paused) {
  BRAHMA_UNWRAPPED_FUNC(H5Eis_paused, herr_t, (stack_id, is_paused));
  return result;
}
#endif

#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Epause_stack(hid_t stack_id) {
  BRAHMA_UNWRAPPED_FUNC(H5Epause_stack, herr_t, (stack_id));
  return result;
}
#endif

#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Eresume_stack(hid_t stack_id) {
  BRAHMA_UNWRAPPED_FUNC(H5Eresume_stack, herr_t, (stack_id));
  return result;
}
#endif
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5ESwait(hid_t es_id, uint64_t timeout, int *num_in_progress,
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5EScancel(hid_t es_id, int *num_not_canceled,
                        hbool_t *err_occurred) {
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5ESget_count(hid_t es_id, int *count) {
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5ESget_err_count(hid_t es_id, int *num_errs) {
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5ESget_err_info(hid_t es_id, int num_err_info,
                              H5ES_err_info_t err_info[], int *err_cleared) {
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5ESfree_err_info(int num_err_info, H5ES_err_info_t err_info[]) {
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pset_relax_file_integrity_checks(hid_t plist_id,
                                                uint64_t flags) {
  BRAHMA_UNWRAPPED_FUNC(H5Pset_relax_file_integrity_checks, herr_t,
                        (plist_id, flags));
  return result;
}
#endif
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5Pget_relax_file_integrity_checks(hid_t plist_id,
                                                uint64_t *flags) {
  BRAHMA_UNWRAPPED_FUNC(H5Pget_relax_file_integrity_checks, herr_t,
                        (plist_id, flags));
  return result;
}
#endif
...
herr_t HDF5::H5FDwrite_selection(H5FD_t *file, H5FD_mem_t type, hid_t dxpl_id,
                                 uint32_t count, hid_t mem_spaces[],
                                 hid_t file_spaces[], haddr_t offsets[],
                                 int element_sizes[], const void *bufs[]) {
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5FDread_vector_from_selection(H5FD_t *file, H5FD_mem_t type,
...
#if (BRAHMA_HDF5_VERSION >= 101405 && BRAHMA_HDF5_VERSION < 101500)
herr_t HDF5::H5TSmutex_acquire(unsigned int lock_count, int *acquired) {
