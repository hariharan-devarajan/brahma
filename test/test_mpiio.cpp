...
int main(int argc, char* argv[]) {
  ...
  MPI_File_create_errhandler(NULL, NULL);

  MPI_File_get_errhandler(NULL, NULL);
  ...
  MPI_File_get_size(NULL, NULL);

  MPI_File_get_group(NULL, NULL);

  MPI_File_get_amode(NULL, NULL);

  MPI_File_set_info(NULL, 0);

  MPI_File_get_info(NULL, NULL);

  MPI_File_set_view(NULL, 0, 0, 0, NULL, 0);

  MPI_File_get_view(NULL, NULL, NULL, NULL, const_cast<char*>(""));
  ...
  MPI_File_get_position(NULL, NULL);

  MPI_File_get_byte_offset(NULL, 0, NULL);
  ...
  MPI_File_get_position_shared(NULL, NULL);

  MPI_File_read_at_all_begin(NULL, 0, NULL, 0, 0);

  MPI_File_read_at_all_end(NULL, NULL, NULL);
  ...
  MPI_File_read_all_end(NULL, NULL, NULL);
  ...
  MPI_File_read_ordered_end(NULL, NULL, NULL);

  MPI_File_write_ordered_begin(NULL, NULL, 0, 0);

  MPI_File_write_ordered_end(NULL, NULL, NULL);

  MPI_File_get_type_extent(NULL, 0, NULL);

  MPI_File_set_atomicity(NULL, 0);

  MPI_File_get_atomicity(NULL, NULL);

  MPI_File_sync(NULL);

  MPI_File_iread_at_all(NULL, 0, NULL, 0, 0, NULL);

  MPI_File_iwrite_at_all(NULL, 0, NULL, 0, 0, NULL);

  MPI_File_iread_all(NULL, NULL, 0, 0, NULL);

  MPI_File_iwrite_all(NULL, NULL, 0, 0, NULL);
